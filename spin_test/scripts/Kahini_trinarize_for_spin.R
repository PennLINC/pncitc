...
for (analysis in analyses) {
    ...
    #  stat_path <- paste0("/", analysis, "/")
     # print(stat_path)
      ...
      ### set paths
      ## input
      lh_stat_map <- read.csv(paste0(homedir, "L_logk_data.txt"), header = F)
      rh_stat_map <- read.csv(paste0(homedir, "R_logk_data.txt"), header = F)
      
      ## output
      lh_outdir <- paste0(homedir, "lh_", result_path, "_", parcel_type, parcel_num, "_1_0_-1.csv")
      rh_outdir <- paste0(homedir, "rh_", result_path, "_", parcel_type, parcel_num, "_1_0_-1.csv")
      
      lh_outdir_pos <- paste0(homedir, "lh_pos_", result_path, "_", parcel_type, parcel_num, "_1_0_-1.csv")
      rh_outdir_pos <- paste0(homedir, "rh_pos_", result_path, "_", parcel_type, parcel_num, "_1_0_-1.csv")
      
      lh_outdir_neg <- paste0(homedir, "lh_neg_", result_path, "_", parcel_type, parcel_num, "_1_0_-1.csv")
      rh_outdir_neg <- paste0(homedir, "rh_neg_", result_path, "_", parcel_type, parcel_num, "_1_0_-1.csv")
